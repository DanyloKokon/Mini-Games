!function(){document.querySelector(".burger-menu").addEventListener("click",()=>{let e=document.querySelector(".nav-menu");e.style.display="none"===e.style.display||""===e.style.display?"block":"none"}),document.querySelector(".js-games");let e=[{id:1,name:"Name-1"},{id:2,name:"Name-2"},{id:3,name:"Name-3"}].map(e=>`<li id=${e.id}>
    <h2>${e.name}</h2>
...
//# sourceMappingURL=Mini-Games.e171e89f.js.map
