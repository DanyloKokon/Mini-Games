const e=document.querySelector(".js-games"),t=[{id:1,name:"Перевір в який рік ти народився",class:"standart"},{id:2,name:"Name-2",class:"standart"},{id:3,name:"Name-3",class:"standart"},{id:4,name:"Калькулятор",class:"standart"}].map(e=>`<li class="reset-li ${e.class}" id=${e.id}>
    <h2 class="flexcenter">${e.name}</h2>
    </li>
    <div class="flexcenter"><div class="line flexcenter"></div></div>`);e.insertAdjacentHTML("afterend",t),document.getElementById("3");const n=document.body,u=document.createElement("div");u.className="game-container";const c=document.createElement("h2");c.textContent="Камінь-Ножиці-Папір";const s=document.createElement("div");s.className="choices";const a=document.createElement("div"),l=document.createElement("button");l.className="choice computer-choice",l.textContent="Комп'ютер вибір";const d=["rock","paper","scissors"];d.forEach(e=>{let t=document.createElement("button");t.className="choice",t.id=e,s.appendChild(t)});const o=document.createElement("div");o.id="result";const i=document.createElement("div");i.id="score";const p=document.createElement("p");p.innerHTML='Ваш рахунок: <span id="player-score">0</span>';const r=document.createElement("p");r.innerHTML="Рахунок комп'ютера: <span id='computer-score'>0</span>",i.appendChild(p),i.appendChild(r),a.appendChild(l),a.appendChild(s),a.appendChild(i),u.appendChild(a),u.appendChild(c),u.appendChild(s),u.appendChild(o),u.appendChild(i),n.appendChild(u);let m=0,b=0;document.querySelectorAll(".choice").forEach(e=>{e.addEventListener("click",()=>{var t,n,u;let c=e.id,s=d[Math.floor(3*Math.random())],a=(t=c)===(n=s)?"draw":"rock"===t&&"scissors"===n||"scissors"===t&&"paper"===n||"paper"===t&&"rock"===n?"win":"lose";"win"===(u=a)&&m++,"lose"===u&&b++,document.getElementById("player-score").textContent=m,document.getElementById("computer-score").textContent=b,function(e,t){let n={win:`\u{412}\u{438} \u{43F}\u{435}\u{440}\u{435}\u{43C}\u{43E}\u{433}\u{43B}\u{438}!`,lose:`\u{412}\u{438} \u{43F}\u{440}\u{43E}\u{433}\u{440}\u{430}\u{43B}\u{438}!`,draw:`\u{41D}\u{456}\u{447}\u{438}\u{44F}!`};document.getElementById("result").textContent=n[e],l.textContent=`\u{412}\u{430}\u{440}\u{456}\u{430}\u{43D}\u{442} \u{43A}\u{43E}\u{43C}\u{43F}\u{2019}\u{44E}\u{442}\u{435}\u{440}\u{430}: ${({rock:"STONE",paper:"PAPER",scissors:"SCISSORS"})[t]}`}(a,s)})});const E=document.getElementById("1"),v=[{class:"inp flexcenter"}].map(e=>`<h2></h2>
        <div class="${e.class}">
